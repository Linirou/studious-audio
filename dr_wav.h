...
extern int drwav__is_little_endian(void);
...
static DRWAV_INLINE drwav_bool32 drwav_init_memory_write(drwav* pWav, void** ppData, size_t* pDataSize, const drwav_data_format* pFormat)
{
    if (ppData == NULL) {
        return DRWAV_FALSE;
    }
